...
SELECT * FROM (SELECT '9a500514-e9bb-40c2-a99c-b96cc67e9ca2'::uuid,'PR0001', 'Infotainment Online', 'Se službami Infotainment Online od Škoda Connect budete na cestách lépe informováni. Vyhledávejte zajímavé cíle ve svém okolí, získávejte aktuální dopravní informace přímo z internetu a mnoho dalších možností.', 1999, 'SERVICE','b2f4d4a5-23f5-48da-a12b-7c56a0e9f8b8'::uuid
               UNION ALL
               SELECT '6f4e4a37-36c6-43b2-8666-0b3ff53c7a2c'::uuid,'PR0002', 'Care Connect - Remote Access', 'Potřebujete odemknout či zamknout svůj vůz Škoda, ale jste od něj příliš daleko? Tato funkce může výrazně zjednodušit mnohé problematické situace, například když zapomenete auto zamknout nebo když do něj chcete pustit někoho jiného. Umožňuje vám odemknout a zamknout vaše vozidlo pomocí portálu Škoda Connect nebo aplikace MyŠkoda. Funguje na jakoukoliv vzdálenost.', 1499, 'PACKAGE', 'b2f4d4a5-23f5-48da-a12b-7c56a0e9f8b8'::uuid
               UNION ALL
               SELECT '640df035-7874-4f22-afb6-6ad9a8e74f41'::uuid,'PR0003', 'Online data for Travel Assist', 'Travel Assist obsahuje celou řadu asistenčních systémů, mezi které patří například prediktivní tempomat, adaptivní vedení v jízdním pruhu nebo vylepšená verze rozpoznávání dopravních značek.', 999, 'SERVICE','b2f4d4a5-23f5-48da-a12b-7c56a0e9f8b8'::uuid
               UNION ALL
               SELECT '4492c542-d7f3-40d5-abfb-e37558aeac81'::uuid,'PR0004', 'Online data for Intelligent Speed Assist', '', 999, 'SERVICE','b2f4d4a5-23f5-48da-a12b-7c56a0e9f8b8'::uuid
               UNION ALL
               ...
               UNION ALL
               SELECT '9fdf506d-0d69-4ea4-b352-c47b4d3eb2aa'::uuid,'PR0008', 'Media Streaming', '', 499, 'PACKAGE', 'b2f4d4a5-23f5-48da-a12b-7c56a0e9f8b8'::uuid
               UNION ALL
               SELECT 'ae309a84-4b1a-46f1-b986-b92670f12b46'::uuid,'PR0009', 'Pay to Park', '', 499, 'PACKAGE', 'c1d8f6b2-94e8-42f5-9c82-8a32c1e1db13'::uuid
              ) AS tmp
WHERE NOT EXISTS (SELECT 1 FROM products);

INSERT INTO purchased_licenses(end_date, product_id, user_id)
    SELECT '2024-02-12'::date, '9a500514-e9bb-40c2-a99c-b96cc67e9ca2'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2024-09-16'::date, '4492c542-d7f3-40d5-abfb-e37558aeac81'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2024-09-16'::date, '640df035-7874-4f22-afb6-6ad9a8e74f41'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2025-10-11'::date, 'c844dfe8-2401-4d15-a1b2-25c168809639'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2030-02-02'::date, 'e7976545-ce25-494d-8a5f-46f2e4b9228d'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2024-02-12'::date, '9fdf506d-0d69-4ea4-b352-c47b4d3eb2aa'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2024-04-04'::date, '6f4e4a37-36c6-43b2-8666-0b3ff53c7a2c'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
    UNION ALL
    SELECT '2030-02-02'::date, '98c89186-797f-4138-abe9-196090c16940'::uuid, '292ae53a-f82c-41d6-b528-884a7d71e4b2'::uuid
